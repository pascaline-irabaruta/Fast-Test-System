<%-- 
    Document   : thankyou
    Created on : 13-Nov-2020, 12:42:30
    Author     : PACY
--%>
...
<html>
    ...
    <body id="tbody">
        ...
        <p id="tk" class="text-center text-white">Your appointment has been recorded. <br>
            Thank you for using Fast<span class="spanLogo">Test</span></p>
        <p class="text-center text-white">For any further help you may need. Please contact us <a href="#Contact">Here</a></p>
    </body>
    <footer>
        <section id="Contact">
